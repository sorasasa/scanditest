    ...
    <div>
        <form id="product_form" name="formMain" @submit="createProduct" >
            ...
            <div class="form-group">
                ...
                <input type="text" name="sku" id="sku" minlength="4" maxlength="10" placeholder="#sku" v-model="sku"  v-validate data-vv-rules=“regex:^[A-Za-z0-9]+$”/>
            ...
            <div class="form-group">
                ...
                <input type="text" name="Name" id="name" minlength="4" maxlength="11" placeholder="#name" v-model="Name" v-validate data-vv-rules=“regex:^[A-Za-z0-9]+$”/>
